...
CREATE TABLE `tbcompras` (
  ...
  CONSTRAINT `tbcompras_ibfk_1` FOREIGN KEY (`idfabricante`) REFERENCES `tbfabricante` (`fabricanteid`),
  CONSTRAINT `tbcompras_ibfk_2` FOREIGN KEY (`id_colab_compra`) REFERENCES `tbcolaborador` (`id_func`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-06-13 10:49:40
