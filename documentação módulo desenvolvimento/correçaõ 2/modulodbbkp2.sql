...
ADD CONSTRAINT Fk_idforn
FOREIGN KEY (idforn) REFERENCES tbfornecedor(fornecedorid);

ALTER TABLE tbproduto
  ADD ifforn int not null after idfabric;
  
ALTER TABLE tbproduto CHANGE ifforn idforn int not null;
